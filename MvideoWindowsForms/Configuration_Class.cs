...
namespace MvideoWindowsForms
{
    ...
    {
        private string SubKey = "Server_Configuration_MVideo";
        ...
        public void SQL_Server_Configuration_Get()
        {
            ...
            RegistryKey key = registry.CreateSubKey(SubKey);
            try
            {
            ...
            finally
            {
                ...
                //connection.ConnectionString = @"Data Source = DESKTOP - F28KLAR\SQLEXPRESS; Initial Catalog = ShopMvideo; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False";
            }
        }
        /// <summary>
